...
<div class="easyui-panel" id="view_position">
    <div id="show_datagrid">
		...
		">
            <thead>
            <tr>
                <th field="nid" width="20">信息号</th>
                <th field="title"  width="60">标题</th>
                <th field="digest"  width="60">摘要</th>
                <th field="postTime" width="40">发布日期</th>
                <th field="name"  width="20">发布人</th>
                <th data-options="field:'isPublic',width:'20', formatter:format">是否公开</th>
                <th field="applyNum"  width="10">申请人数</th>
                <th field="messageNum"  width="10">留言数目</th>
                <th field="lookedNum"  width="10">可查看人数</th>
            </tr>
            </thead>
        </table>
        <div id="toolbar">
